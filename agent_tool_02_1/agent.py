...
currency_agent = LlmAgent(
    ...
    5. First, state the final converted amount.
        ...
        Your explanation must include: the fee percentage and its
        value in the original currency, the amount remaining after the fee, 
        and the exchange rate used for the final conversion.
...
calculation_agent = LlmAgent(
    ...
    You are forbidden from providing any text, explanations, or conversational responses.
     ...
     Your task is to take a request for a calculation and 
     translate it into a single block of Python code that calculates the answer.
...
root_agent = LlmAgent(
  ...
  For any currency conversion request:
   ...
   You must use the calculation_agent tool to generate Python code that calculates the final converted amount. This 
...
if __name__ == "__main__":
    asyncio.run(run_debug("I want to convert 500 US Dollars to Euros using my Platinum Credit Card. How much will I receive?"))